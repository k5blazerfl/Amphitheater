...
| Package | Description |
| --- | --- |
| `app-admin/gest` | [GeST](https://github.com/k5blazerfl/GeST) — a YaST-style, full-screen TUI system administration tool for Gentoo (Portage, services, users, network). Released `0.32.0` + live `-9999`. |
...
`app-admin/gest-0.32.0` is a released version (`~amd64`); `gest-9999` tracks
